...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">QuarkCount</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
  ...
  shouldComponentUpdate(
    propName: <span class="hljs-built_in">string</span>,
    <span class="hljs-attr">oldValue</span>: <span class="hljs-built_in">string</span> | <span class="hljs-built_in">boolean</span>,
    <span class="hljs-attr">newValue</span>: <span class="hljs-built_in">string</span> | <span class="hljs-built_in">boolean</span>
  ...
  <span class="hljs-function"><span class="hljs-title">componentDidUpdate</span>(<span class="hljs-params">propName: <span class="hljs-built_in">string</span>, oldValue: <span class="hljs-built_in">string</span>, newValue: <span class="hljs-built_in">string</span></span>)</span> {
...
</code></pre>`,6),e=[c],i={},h="",j=a({__name:"lifecycle.en-US",setup(p,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,d)=>(t(),n("div",u,e))}});export{j as default,h as excerpt,i as frontmatter};
