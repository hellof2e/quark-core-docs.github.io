import{d as a,c as n,b as l,o as t}from"./vue.0c0454b4.js";const p={class:"markdown-body"},e=l(`<h2>Ref</h2><p>\u901A\u8FC7 <code class="">ref</code> \u83B7\u53D6 <code class="">dom</code> \u8282\u70B9\u5B9E\u4F8B\u3002</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement,
  customElement,
  property,
  state,
  createRef,
...
</code></pre>`,3),c=[e],i={},d="",j=a({__name:"ref.en-US",setup(r,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,h)=>(t(),n("div",p,c))}});export{j as default,d as excerpt,i as frontmatter};
