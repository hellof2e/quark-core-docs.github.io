...
</code></pre><pre><code class="language-css"><span class="hljs-comment">/*
* index.css
*/</span>

<span class="hljs-selector-pseudo">:host</span> <span class="hljs-selector-class">.quark_count_button</span> {
...
</code></pre><p>\u63A8\u8350\u4F7F\u7528\u72EC\u7ACB <code class="">css</code> \u6587\u4EF6\u7684\u65B9\u5F0F\u6765\u5F00\u53D1\u3002</p><h3>\u4E3B\u9898</h3><p>\u53EF\u4EE5\u4F7F\u7528 <code class="">css</code> <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/--*">\u81EA\u5B9A\u4E49\u5C5E\u6027</a>\u7684\u65B9\u5F0F\u6765\u81EA\u5B9A\u4E49\u4E3B\u9898\u3002</p><pre><code class="language-css"><span class="hljs-comment">/*
* index.css
*/</span>

<span class="hljs-selector-pseudo">:host</span> <span class="hljs-selector-class">.quark_count_button</span> {
  <span class="hljs-attribute">color</span>: <span class="hljs-built_in">var</span>(--quark-primary-color, red);
}
<span class="hljs-selector-pseudo">:host</span>(<span class="hljs-selector-attr">[disabled]</span>) {
  <span class="hljs-attribute">color</span>: <span class="hljs-built_in">var</span>(--quark-disable-color, gray);
}
</code></pre>`,13),c=[e],j={},d="",i=a({__name:"styles.zh-CN",setup(u,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,r)=>(p(),n("div",t,c))}});export{i as default,d as excerpt,j as frontmatter};
