...
</code></pre><h3>State</h3><p>\u901A\u8FC7 <code class="">@state</code> \u4E3A\u4F60\u7EC4\u4EF6\u7684\u5185\u90E8\u72B6\u6001\u589E\u52A0\u54CD\u5E94\u5F0F\u7279\u6027\u3002</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, state} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre><p>\u70B9\u51FB\u6309\u94AE\u540E\uFF0C\u7EC4\u4EF6\u5C06\u81EA\u52A8\u66F4\u65B0\u3002</p><h3>\u9AD8\u7EA7\u6280\u5DE7</h3><p>\u9488\u5BF9\u6709\u4E9B\u7EC4\u4EF6\u9700\u8981\u4F20\u9012\u590D\u6742\u6570\u636E\u7C7B\u578B\u7684\u573A\u666F\uFF0C\u53EF\u91C7\u7528\u5982\u4E0B\u65B9\u5F0F\uFF1A</p><p>\u7EC4\u4EF6\u5185\u90E8\u66B4\u9732\u4E00\u4E2A <code class="">setData</code> \u65B9\u6CD5\u3002</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> MyPicker;
...
</code></pre><p><a href="https://github.com/hellof2e/quark-design/blob/main/packages/quarkd/src/cascadepicker/index.tsx">\u66F4\u591A\u4F7F\u7528\u6280\u5DE7\u53C2\u8003</a></p>`,23),c=[t],j={},F="",E=a({__name:"properties.en-US",setup(e,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,o)=>(l(),u("div",p,c))}});export{E as default,F as excerpt,j as frontmatter};
