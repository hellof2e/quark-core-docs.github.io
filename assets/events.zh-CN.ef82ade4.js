import{d as n,c as a,b as u,o as t}from"./vue.fd6f0b29.js";const l={class:"markdown-body"},p=u(`<h2>Events</h2><h3>\u539F\u751F\u4E8B\u4EF6</h3><p>\u901A\u8FC7 <code class="">onXXX</code> \u7684\u65B9\u5F0F\u76D1\u542C\u539F\u751F\u4E8B\u4EF6\u3002</p><pre><code class="language-tsx">import { QuarkElement, customElement } from &quot;quarkc&quot;
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Input</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
...
&lt;quark-input <span class="hljs-meta">@input</span>=<span class="hljs-string">&quot;this.onInput&quot;</span>/&gt;
...
</code></pre><p>\u901A\u8FC7 <code class="">this.$emit</code> \u89E6\u53D1\u81EA\u5B9A\u4E49\u4E8B\u4EF6\uFF0C<code class="">emit</code> \u7684\u7B2C\u4E00\u4E2A\u53C2\u6570\u4E3A\u4E8B\u4EF6\u540D\uFF0C\u7B2C\u4E8C\u4E2A\u53C2\u6570\u4E3A\u4F20\u9012\u7684\u53C2\u6570\u3002\u53EF\u901A\u8FC7 <code class="">evt.detail</code> \u83B7\u53D6\u5230\u4F20\u9012\u7684\u6570\u636E\u3002</p>`,12),e=[p],h={},E="",d=n({__name:"events.zh-CN",setup(c,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,r)=>(t(),a("div",l,e))}});export{d as default,E as excerpt,h as frontmatter};
