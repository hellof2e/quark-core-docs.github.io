import{d as a,c as n,b as t,o as l}from"./vue.051b3dff.js";const p={class:"markdown-body"},u=t(`<h2>Development</h2><p><code class="">quarkc</code> \u652F\u6301 <code class="">TypeScript</code>\uFF0C\u7528 <code class="">quarkc</code> \u7F16\u5199\u4E00\u4E2A\u7EC4\u4EF6\uFF0C\u5176\u4EE3\u7801\u7ED3\u6784\u5927\u6982\u5982\u4E0B\uFF1A</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, property } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre>`,8),o=[u],h={},i="",q=a({__name:"development.en-US",setup(e,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(c,r)=>(l(),n("div",p,o))}});export{q as default,i as excerpt,h as frontmatter};
