import{d as a,c as n,b as l,o as p}from"./vue.3b8b5948.js";const t={class:"markdown-body"},e=l(`<h2>Slot \u63D2\u69FD</h2><h3>\u9ED8\u8BA4\u63D2\u69FD</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-count</span>&gt;</span>\u6211\u662F\u9ED8\u8BA4\u63D2\u69FD<span class="hljs-tag">&lt;/<span class="hljs-name">quark-count</span>&gt;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Count</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
  ...
  <span class="hljs-keyword">const</span> { current } = <span class="hljs-built_in">this</span>.ref
  }
  <span class="hljs-function"><span class="hljs-title">render</span>(<span class="hljs-params"></span>)</span> {
    <span class="hljs-keyword">return</span> (
      <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">button</span>&gt;</span>
...
</code></pre><p>\u66F4\u591A <code class="">slot</code> \u63D2\u69FD\u4F7F\u7528\u53EF\u53C2\u8003<a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_templates_and_slots">Slot</a></p>`,12),c=[e],j={},d="",m=a({__name:"slot.zh-CN",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,r)=>(p(),n("div",t,c))}});export{m as default,d as excerpt,j as frontmatter};
