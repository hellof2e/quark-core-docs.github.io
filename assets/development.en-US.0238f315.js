import{d as a,c as n,b as l,o as t}from"./vue.e0b913aa.js";const e={class:"markdown-body"},p=l(`<h2>Development</h2><blockquote><p>\u63A8\u8350\u4F7F\u7528\uFF1A<a href="https://github.com/hellof2e/quark-cli">https://github.com/hellof2e/quark-cli</a> \u751F\u6210\u9879\u76EE</p></blockquote><p><code class="">quarkc</code> \u652F\u6301 <code class="">TypeScript</code>\uFF0C\u7528 <code class="">quarkc</code> \u7F16\u5199\u4E00\u4E2A\u7EC4\u4EF6\uFF0C\u5176\u4EE3\u7801\u7ED3\u6784\u5927\u6982\u5982\u4E0B\uFF1A</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, property } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Text</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
...
</code></pre>`,6),c=[p],d={},m="",j=a({__name:"development.en-US",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,r)=>(t(),n("div",e,c))}});export{j as default,m as excerpt,d as frontmatter};
