...
</code></pre><p><code class="">Quarkc</code> \u4F7F\u7528 <code class="">tsx/jsx</code> \u6765\u4F5C\u4E3A <code class="">UI</code> \u8868\u8FBE\u5F0F\uFF0C\u56E0\u6B64 <code class="">render</code> \u51FD\u6570\u5185\u53EF\u4EE5\u5305\u542B\u4EFB\u4F55 <code class="">tsx/jsx</code> \u8BED\u6CD5,\u5982\u6761\u4EF6\u6E32\u67D3\u3001\u4E09\u76EE\u8FD0\u7B97\u7B26\u7B49\u3002\u4F60\u53EF\u4EE5\u50CF\u5199 <code class="">React</code> \u7EC4\u4EF6\u4E00\u6837\uFF0C\u5199 <code class="">Quarkc</code> \u7EC4\u4EF6\u3002</p><p>\u6761\u4EF6\u6E32\u67D3\uFF1A</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>

<span class="hljs-meta">@customElement</span>({ <span class="hljs-attr">tag</span>: <span class="hljs-string">&quot;my-element&quot;</span> })
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyElement</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyCount</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">QuarkElement</span> </span>{
...
</code></pre><p>\u7B49\u2026</p>`,11),c=[e],j={},d="",m=a({__name:"rendering.zh-CN",setup(u,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,o)=>(p(),n("div",t,c))}});export{m as default,d as excerpt,j as frontmatter};
